...
using isaac_float4 = glm::vec4;
using isaac_float3 = glm::vec3;
using isaac_float2 = glm::vec2;

using isaac_uint4 = glm::uvec4;
using isaac_uint3 = glm::uvec3;
using isaac_uint2 = glm::uvec2;

using isaac_int4 = glm::ivec4;
using isaac_int3 = glm::ivec3;
using isaac_int2 = glm::ivec2;
...
using isaac_float_dim = glm::vec<T, float, glm::defaultp>;
template <ISAAC_IDX_TYPE T>
using isaac_int_dim = glm::vec<T, int, glm::defaultp>;
template <ISAAC_IDX_TYPE T>
