...
namespace isaac
{
    struct IsaacFunctorIdem
    {
        ...
        template<int N>
        ISAAC_DEVICE_INLINE static isaac_float_dim<N> call(const isaac_float_dim<N> v, const isaac_float4& p)
        {
            return v;
        }
    ...
    struct IsaacFunctorLength
    {
        ...
        template<int N>
        ISAAC_DEVICE_INLINE static isaac_float_dim<1> call(const isaac_float_dim<N> v, const isaac_float4& p)
        {
