...
#    define ISAAC_USE_CUDA_TEXTURES
#endif
...
#define ISAAC_HOST_DEVICE_INLINE ALPAKA_FN_HOST_ACC ALPAKA_FN_INLINE


#define ISAAC_HOST_INLINE ALPAKA_FN_HOST inline

#define ISAAC_DEVICE_INLINE ALPAKA_FN_ACC ALPAKA_FN_INLINE

#define ISAAC_DEVICE ALPAKA_FN_ACC

#define ISAAC_NO_HOST_DEVICE_WARNING ALPAKA_NO_HOST_ACC_WARNING
