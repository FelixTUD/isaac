...
int main ( int argc, char **argv )
{
    ...
    cudaMalloc ( ( float3_t** ) &deviceBuffer1, sizeof ( float3_t ) *prod );
    float* hostBuffer2 = ( float* ) malloc ( sizeof ( float ) *prod );
    float* deviceBuffer2;
    cudaMalloc ( ( float** ) &deviceBuffer2, sizeof ( float ) *prod );
    float3_t* hostBuffer3 = ( float3_t* ) malloc ( sizeof ( float3_t ) *PARTICLE_COUNT );
    float3_t* deviceBuffer3;
    cudaMalloc ( ( float3_t** ) &deviceBuffer3, sizeof ( float3_t ) *PARTICLE_COUNT );
#endif
