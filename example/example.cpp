...
public:
    ...
    ISAAC_NO_HOST_DEVICE_WARNING ISAAC_HOST_DEVICE_INLINE isaac_float_dim<featureDim> operator[](
        const isaac_int3& nIndex) const
    {
...
public:
    ...
    ParticleIterator1(T_ElemType* firstElement, size_t size, const isaac_uint3& localGridCoord)
...
public:
    ...
    ISAAC_NO_HOST_DEVICE_WARNING ParticleSource1(isaac_float3* ptr, size_t size) : ptr(ptr), size(size)
    {
    }
    ...
    ISAAC_NO_HOST_DEVICE_WARNING ISAAC_HOST_DEVICE_INLINE ParticleIterator1<featureDim, isaac_float3> getIterator(
        const isaac_uint3& localGridCoord) const
    {
